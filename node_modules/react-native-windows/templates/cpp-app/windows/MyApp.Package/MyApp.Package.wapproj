...
<Project ToolsVersion="Current" DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    <ProjectGuid>{{ packageGuidLower }}</ProjectGuid>
    <DefaultLanguage>en-US</DefaultLanguage>
    <EntryPointProjectUniqueName>..\{{ name }}\{{ name }}.vcxproj</EntryPointProjectUniqueName>
  ...
  <ItemGroup>
    <ProjectReference Include="..\{{ name }}\{{ name }}.vcxproj">
