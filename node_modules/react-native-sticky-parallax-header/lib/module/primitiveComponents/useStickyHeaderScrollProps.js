...
import { runOnJS, scrollTo, useAnimatedReaction, useAnimatedRef, useSharedValue, useWorkletCallback } from 'react-native-reanimated';
import { useResponsiveSize } from '../hooks/useResponsiveSize';
const VELOCITY_THRESHOLD = 7;
export function useStickyHeaderScrollProps(props) {
  const {
    responsiveHeight
  } = useResponsiveSize();
  const {
...
//# sourceMappingURL=useStickyHeaderScrollProps.js.map