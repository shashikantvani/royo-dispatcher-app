...
var Cvv = function (props) {
    return (<FramesConsumer>
      {function (_a) {
        ...
        return (<TextInput autoCompleteType="cc-csc" keyboardType="number-pad" returnKeyType="done" secureTextEntry={true} placeholder={DEFAULT_CVV_PLACEHOLDER} {...props} style={[styles.cvv, props.style]} value={state.cvv} maxLength={state.cvvLength} onChangeText={function (val) {
