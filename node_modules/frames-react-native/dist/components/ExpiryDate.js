...
var ExpiryDate = function (props) {
    return (<FramesConsumer>
      {function (_a) {
        ...
        return (<TextInput autoCompleteType="cc-exp" keyboardType="number-pad" maxLength={5} returnKeyType="done" placeholder={DEFAULT_CARD_EXPIRY_DATE_PLACEHOLDER} {...props} style={[styles.expiryDate, props.style]} value={state.expiryDate} onChangeText={function (val) {
