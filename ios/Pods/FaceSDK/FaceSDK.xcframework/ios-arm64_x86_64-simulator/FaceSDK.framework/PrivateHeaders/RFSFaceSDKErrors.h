...
typedef NS_ERROR_ENUM(RFSLivenessServiceErrorDomain, RFSLivenessServiceErrorCode) {
    ...
    RFSLivenessServiceErrorCameraNotAvailable,
    /// Core service can't start session
    RFSLivenessServiceErrorSessionStartFailed,
    /// Core service can't process frame
    RFSLivenessServiceErrorProcessingFrameFailed
